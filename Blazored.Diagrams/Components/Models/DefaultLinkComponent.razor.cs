...
public abstract partial class DefaultLinkComponent
{
    ...
    /// <summary>
    /// Handles the <see cref=""/>
    /// </summary>
    /// <param name="obj"></param>
    protected virtual void OnLinkSelectionChanged(LinkSelectionChangedEvent obj)
    {
        StrokeColor = obj.Model.IsSelected ? SelectedStrokeColor : StrokeColor;
    }
